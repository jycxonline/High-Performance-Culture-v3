...
# New PACE journey — straight-line running stages
PACE_STAGES = [
    "Not Started",
    "Warm-up Exercise",       # survey launched / boarding
    "Training",               # activated (>=70%)
    "Reflect",                # report reviewed
    "Implement Change",       # action plan submitted
    "Reflect Again",          # checkpoint 1 done  (displayed as "Reflect")
    "Training - Tempo",       # checkpoint 2 done
    "Race up your PACE",      # checkpoint 3 done
    "Finish Line",            # destination / journey complete
]
STAGE_TO_INDEX = {s: i for i, s in enumerate(PACE_STAGES)}

# Display labels (two "Reflect" stages)
STAGE_DISPLAY = {
...
DESTINATIONS = [  # kept for compatibility; used as 'race medals'
